...
if __name__ == "__main__":
    ...
    for element in aircraft:
        print(element.id, element.origin_airport, element.time_of_landing, element.company)
        llista_aircrafts=LoadArrivals ('Arrivals.txt')
    SaveFlights(llista_aircrafts, 'New_arrivals.txt')